...
<div id="wrapper">
	...
	<div id="page">
		...
		<ul>
				<li>
					<p>
					<object type="application/x-shockwave-flash" width="800" height="300" data="http://bluelunarquartet.com/PictureViewer.swf">
					<param name="movie" value="http://bluelunarquartet.com/PictureViewer.swf" />
